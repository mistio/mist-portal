...
export default class OrgSettings extends connect(store)(LitElement) {
  static get styles() {
    return css`
      :host {
        height: 100%;
  ...
  constructor() {
    super();
    this.jsonSchema = {
      $ref: `${BASE_API_SPEC}#/components/schemas/EditOrganizationRequest`,
    };
    this.uiSchema = {
      description: {
        'ui:widget': 'textarea',
...
customElements.define('org-settings', OrgSettings);
